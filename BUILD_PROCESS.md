...
ApproachWhy RejectedMachine learning modelNo training data; overkill for 3–8 optionsDecision treeHard to generalize; becomes a long if/else chainGoogle Sheets integrationAdds OAuth complexity for no benefitReact frontendOverkill — vanilla JS is sufficient and has no build stepExternal destination data APIAdds network dependency, harder to explain scores
